...
lvim.builtin.neoscroll = { active = true }
lvim.builtin.sell_your_soul_to_devil = { active = false }
...
if lvim.builtin.fancy_statusline.active then
  require("user.configurations.lualine").config()
end
